...
public class CalculadoraTeste {
	...
	public void testarSoma() {
		assertAll("Deve testar somar", () -> {
			...
			// O .02 representa a margem de erro que o teste aceita
			...
			// Método somar(7,-7) deve retornar 0
			// O .02 representa a margem de erro que o teste aceita
			assertEquals(calculadora.somar(7, -7), 0, .02);
		});
	}
	...
	public void testarSubtracao() {
		assertAll("Deve testar subtração", () -> {
			...
			// Método somar(7,-7) deve retornar 7
			// O .02 representa a margem de erro que o teste aceita
			assertEquals(calculadora.subtrair(7, -7), 14, .02);
		});
	}
